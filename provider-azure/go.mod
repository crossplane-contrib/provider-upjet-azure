module github.com/upbound/official-providers/provider-azure

go 1.17

replace github.com/upbound/upjet => github.com/muvaf/upjet 215d01cec0d96bdc4139fba990ee452333d8f88f
