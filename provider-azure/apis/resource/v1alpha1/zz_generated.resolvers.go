...
// ResolveReferences of this GroupCostManagementExport.
func (mg *GroupCostManagementExport) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this GroupPolicyExemption.
func (mg *GroupPolicyExemption) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this GroupPolicyRemediation.
func (mg *GroupPolicyRemediation) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
