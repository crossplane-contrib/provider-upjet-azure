...
type ServerParameters struct {
	...
	// Specifies the SKU Name for this PostgreSQL Server. The name of the SKU, follows the tier + family + cores pattern . For more information see the product documentation.
	// +kubebuilder:validation:Required
