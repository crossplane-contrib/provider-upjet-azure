...
type TableAutoscaleSettingsParameters struct {
	...
	// The maximum throughput of the Table . Must be between 1,000 and 1,000,000. Must be set in increments of 1,000. Conflicts with throughput.
...
type TableParameters struct {
	...
	// The throughput of Table . Must be set in increments of 100. The minimum value is 400. This must be set upon database creation otherwise it cannot be updated without a manual terraform destroy-apply.
	// +kubebuilder:validation:Optional
