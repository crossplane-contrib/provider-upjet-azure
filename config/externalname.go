...
var TerraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	"azurerm_postgresql_flexible_server_virtual_endpoint": config.TemplatedStringAsIdentifier("name", "{{ .parameters.source_server_id }}/virtualEndpoints/{{ .external_name }}|{{ .parameters.replica_server_id }}/virtualEndpoints/{{ .external_name }}"),
