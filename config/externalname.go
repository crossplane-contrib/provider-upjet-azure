...
var TerraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	"azurerm_redis_cache_access_policy":            config.TemplatedStringAsIdentifier("name", "/subscriptions/{{ .setup.configuration.subscription_id }}/resourceGroups/{{ .parameters.resource_group_name }}/providers/Microsoft.Cache/redis/{{ .parameters.redis_cache_name }}/accessPolicies/{{ .external_name }}"),
	"azurerm_redis_cache_access_policy_assignment": config.TemplatedStringAsIdentifier("name", "/subscriptions/{{ .setup.configuration.subscription_id }}/resourceGroups/{{ .parameters.resource_group_name }}/providers/Microsoft.Cache/redis/{{ .parameters.redis_cache_name }}/accessPolicyAssignments/{{ .external_name }}"),
