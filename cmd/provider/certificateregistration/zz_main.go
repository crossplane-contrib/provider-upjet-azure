...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_certificateregistration(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_certificateregistration(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
