...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_marketplaceordering(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_marketplaceordering(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
