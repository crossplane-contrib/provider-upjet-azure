...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_operationsmanagement(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_operationsmanagement(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
