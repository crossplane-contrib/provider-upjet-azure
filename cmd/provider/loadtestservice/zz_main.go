...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_loadtestservice(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_loadtestservice(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
