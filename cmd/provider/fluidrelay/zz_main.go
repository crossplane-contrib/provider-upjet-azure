...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_fluidrelay(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_fluidrelay(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
