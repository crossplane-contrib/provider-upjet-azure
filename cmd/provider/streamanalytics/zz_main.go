...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_streamanalytics(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_streamanalytics(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
