...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_deviceupdate(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_deviceupdate(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
