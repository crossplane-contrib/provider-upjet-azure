...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_appconfiguration(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_appconfiguration(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
