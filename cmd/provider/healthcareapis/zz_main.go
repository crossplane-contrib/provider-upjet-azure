...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_healthcareapis(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_healthcareapis(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
