...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_cognitiveservices(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_cognitiveservices(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
