...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_confidentialledger(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_confidentialledger(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
