...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_notificationhubs(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_notificationhubs(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
