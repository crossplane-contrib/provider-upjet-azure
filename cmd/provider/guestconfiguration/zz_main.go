...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(clustercontroller.Setup_guestconfiguration(mgr, clusterOpts), "Cannot setup cluster-scoped AzureAD controllers")
		kingpin.FatalIfError(namespacedcontroller.Setup_guestconfiguration(mgr, namespacedOpts), "Cannot setup namespaced AzureAD controllers")
	}
