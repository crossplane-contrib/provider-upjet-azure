...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	ac := tjcontroller.NewAPICallbacks(mgr, xpresource.ManagedKind(v1beta1.MonitorScheduledQueryRulesAlert_GroupVersionKind), tjcontroller.WithEventHandler(o.EventHandler))
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["azurerm_monitor_scheduled_query_rules_alert"], tjcontroller.WithLogger(o.Logger), tjcontroller.WithConnectorEventHandler(o.EventHandler),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1beta1.MonitorScheduledQueryRulesAlert{}, o.EventHandler).
