...
//go:generate go run -tags generate sigs.k8s.io/controller-tools/cmd/controller-gen object:headerFile=../hack/boilerplate.go.txt paths=../apis/... crd:crdVersions=v1,allowDangerousTypes=true output:artifacts:config=../package/crds
...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g azure.upbound.io -a github.com/upbound/provider-azure/v2/internal/apis -o azure.azure.upbound.io=azure.upbound.io -s -p ../apis/cluster/...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g azure.m.upbound.io -a github.com/upbound/provider-azure/v2/internal/apis -o azure.azure.m.upbound.io=azure.m.upbound.io -s -p ../apis/namespaced/...
