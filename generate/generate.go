...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g azure.m.upbound.io -a github.com/upbound/provider-azure/internal/apis -o azure.azure.upbound.io=azure.upbound.io -s -p ../apis/namespaced/...
