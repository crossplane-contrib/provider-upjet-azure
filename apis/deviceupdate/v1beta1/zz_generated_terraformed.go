...
// SetInitParameters for this IOTHubDeviceUpdateAccount
func (tr *IOTHubDeviceUpdateAccount) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
func (tr *IOTHubDeviceUpdateInstance) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"diagnostic_storage_account[*].connection_string": "spec.forProvider.diagnosticStorageAccount[*].connectionStringSecretRef"}
}
...
// SetInitParameters for this IOTHubDeviceUpdateInstance
func (tr *IOTHubDeviceUpdateInstance) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
func (tr *IOTHubDeviceUpdateInstance) LateInitialize(attrs []byte) (bool, error) {
	params := &IOTHubDeviceUpdateInstanceParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
