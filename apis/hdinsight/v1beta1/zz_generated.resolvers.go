		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Roles[i3].HeadNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Roles[i3].HeadNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Roles[i3].HeadNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Roles[i3].WorkerNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Roles[i3].WorkerNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Roles[i3].WorkerNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Roles[i3].ZookeeperNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Roles[i3].ZookeeperNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Roles[i3].ZookeeperNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Roles[i3].HeadNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Roles[i3].HeadNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Roles[i3].HeadNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Roles[i3].WorkerNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Roles[i3].WorkerNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Roles[i3].WorkerNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Roles[i3].ZookeeperNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Roles[i3].ZookeeperNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Roles[i3].ZookeeperNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Roles[i3].KafkaManagementNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Roles[i3].KafkaManagementNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Roles[i3].KafkaManagementNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Roles[i3].KafkaManagementNode); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Roles[i3].KafkaManagementNode[i4].SubnetID, ""),
					Extract:      rconfig.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Roles[i3].KafkaManagementNode[i4].SubnetID = ptr.To(rsp.ResolvedValue)
