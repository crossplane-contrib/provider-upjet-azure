...
func (mg *PrivateDNSResolverInboundEndpoint) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.PrivateDNSResolverID")
	}
	mg.Spec.InitProvider.PrivateDNSResolverID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.PrivateDNSResolverIDRef = rsp.ResolvedReference
