...
// GetConnectionDetailsMapping for this PrivateDNSResolverVirtualNetworkLink
func (tr *PrivateDNSResolverVirtualNetworkLink) GetConnectionDetailsMapping() map[string]string {
	return nil
}
...
// GetID returns ID of underlying Terraform resource of this PrivateDNSResolverVirtualNetworkLink
func (tr *PrivateDNSResolverVirtualNetworkLink) GetID() string {
...
// GetInitParameters of this PrivateDNSResolverVirtualNetworkLink
func (tr *PrivateDNSResolverVirtualNetworkLink) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PrivateDNSResolverVirtualNetworkLink
func (tr *PrivateDNSResolverVirtualNetworkLink) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *PrivateDNSResolverVirtualNetworkLink) GetTerraformSchemaVersion() int {
	return 0
}
