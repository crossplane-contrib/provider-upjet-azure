		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Filter[i3].Dimension); i4++ {
			{
				...
				mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
					CurrentValues: helper.FromPtrValues(mg.Spec.ForProvider.Filter[i3].Dimension[i4].Values),
			...
			mg.Spec.ForProvider.Filter[i3].Dimension[i4].Values = helper.ToPtrValues(mrsp.ResolvedValues)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Filter[i3].Dimension); i4++ {
			{
				...
				mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
					CurrentValues: helper.FromPtrValues(mg.Spec.InitProvider.Filter[i3].Dimension[i4].Values),
					Extract:       reference.ExternalName(),
			...
			mg.Spec.InitProvider.Filter[i3].Dimension[i4].Values = helper.ToPtrValues(mrsp.ResolvedValues)
