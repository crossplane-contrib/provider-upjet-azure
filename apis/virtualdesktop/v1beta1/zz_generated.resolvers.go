...
func (mg *Application) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &ApplicationGroupList{},
			Managed: &ApplicationGroup{},
		},
	})
	if err != nil {
...
// ResolveReferences of this HostPool.
func (mg *HostPool) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this HostPoolRegistrationInfo.
func (mg *HostPoolRegistrationInfo) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this ScalingPlan.
func (mg *ScalingPlan) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this WorkspaceApplicationGroupAssociation.
func (mg *WorkspaceApplicationGroupAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
