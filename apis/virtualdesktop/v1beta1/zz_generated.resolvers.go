...
// ResolveReferences of this WorkspaceApplicationAssociation.
func (mg *WorkspaceApplicationAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
