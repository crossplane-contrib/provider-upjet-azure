...
// GetTerraformResourceType returns Terraform resource type for this WorkspaceApplicationGroupAssociation
func (mg *WorkspaceApplicationGroupAssociation) GetTerraformResourceType() string {
	return "azurerm_virtual_desktop_workspace_application_group_association"
}

// GetConnectionDetailsMapping for this WorkspaceApplicationGroupAssociation
func (tr *WorkspaceApplicationGroupAssociation) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this WorkspaceApplicationGroupAssociation
func (tr *WorkspaceApplicationGroupAssociation) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this WorkspaceApplicationGroupAssociation
func (tr *WorkspaceApplicationGroupAssociation) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this WorkspaceApplicationGroupAssociation
func (tr *WorkspaceApplicationGroupAssociation) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this WorkspaceApplicationGroupAssociation
func (tr *WorkspaceApplicationGroupAssociation) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this WorkspaceApplicationGroupAssociation
func (tr *WorkspaceApplicationGroupAssociation) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// GetInitParameters of this WorkspaceApplicationGroupAssociation
func (tr *WorkspaceApplicationGroupAssociation) GetInitParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.InitProvider)
	if err != nil {
		return nil, err
	}
...
// LateInitialize this WorkspaceApplicationGroupAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *WorkspaceApplicationGroupAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &WorkspaceApplicationGroupAssociationParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *WorkspaceApplicationGroupAssociation) GetTerraformSchemaVersion() int {
	return 1
}
