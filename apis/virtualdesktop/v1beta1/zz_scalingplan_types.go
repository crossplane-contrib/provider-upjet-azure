...
type ScalingPlanHostPoolInitParameters struct {
...
type ScalingPlanHostPoolObservation struct {
...
type ScalingPlanHostPoolParameters struct {
...
type ScalingPlanInitParameters struct {
	...
	HostPool []ScalingPlanHostPoolInitParameters `json:"hostPool,omitempty" tf:"host_pool,omitempty"`
	...
	Schedule []ScalingPlanScheduleInitParameters `json:"schedule,omitempty" tf:"schedule,omitempty"`
...
type ScalingPlanObservation struct {
	...
	// One or more host_pool blocks as defined below.
	HostPool []ScalingPlanHostPoolObservation `json:"hostPool,omitempty" tf:"host_pool,omitempty"`
	...
	// One or more schedule blocks as defined below.
	Schedule []ScalingPlanScheduleObservation `json:"schedule,omitempty" tf:"schedule,omitempty"`
...
type ScalingPlanParameters struct {
	...
	// One or more host_pool blocks as defined below.
	// +kubebuilder:validation:Optional
	HostPool []ScalingPlanHostPoolParameters `json:"hostPool,omitempty" tf:"host_pool,omitempty"`
	...
	// One or more schedule blocks as defined below.
	// +kubebuilder:validation:Optional
	Schedule []ScalingPlanScheduleParameters `json:"schedule,omitempty" tf:"schedule,omitempty"`
...
type ScalingPlanScheduleInitParameters struct {
...
type ScalingPlanScheduleObservation struct {
...
type ScalingPlanScheduleParameters struct {
...
// ScalingPlan is the Schema for the ScalingPlans API. Manages a Virtual Desktop Scaling Plan .
