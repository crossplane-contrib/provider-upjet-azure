...
// ConvertTo converts this RedisCache to the hub type.
func (tr *RedisCache) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the RedisCache type.
func (tr *RedisCache) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
