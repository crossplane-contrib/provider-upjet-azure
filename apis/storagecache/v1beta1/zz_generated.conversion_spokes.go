...
// ConvertTo converts this HPCCache to the hub type.
func (tr *HPCCache) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the HPCCache type.
func (tr *HPCCache) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
