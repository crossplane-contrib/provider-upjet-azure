...
// GetInitParameters of this StorageSync
func (tr *StorageSync) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StorageSync
func (tr *StorageSync) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
