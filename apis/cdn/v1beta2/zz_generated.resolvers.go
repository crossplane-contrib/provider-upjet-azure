	...
	if mg.Spec.ForProvider.PrivateLink != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.PrivateLink.Location, ""),
		...
		mg.Spec.ForProvider.PrivateLink.Location = ptr.To(rsp.ResolvedValue)
	...
	if mg.Spec.ForProvider.PrivateLink != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.PrivateLink.PrivateLinkTargetID, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.ForProvider.PrivateLink.PrivateLinkTargetID = ptr.To(rsp.ResolvedValue)
	...
	if mg.Spec.InitProvider.PrivateLink != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.PrivateLink.Location, ""),
				Extract:      resource.ExtractParamPath("location", false),
		...
		mg.Spec.InitProvider.PrivateLink.Location = ptr.To(rsp.ResolvedValue)
	...
	if mg.Spec.InitProvider.PrivateLink != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.PrivateLink.PrivateLinkTargetID, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.InitProvider.PrivateLink.PrivateLinkTargetID = ptr.To(rsp.ResolvedValue)
		...
		if mg.Spec.ForProvider.Actions.RouteConfigurationOverrideAction != nil {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Actions.RouteConfigurationOverrideAction.CdnFrontdoorOriginGroupID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Actions.RouteConfigurationOverrideAction.CdnFrontdoorOriginGroupID = ptr.To(rsp.ResolvedValue)
		...
		if mg.Spec.InitProvider.Actions.RouteConfigurationOverrideAction != nil {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Actions.RouteConfigurationOverrideAction.CdnFrontdoorOriginGroupID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Actions.RouteConfigurationOverrideAction.CdnFrontdoorOriginGroupID = ptr.To(rsp.ResolvedValue)
				...
				for i6 := 0; i6 < len(mg.Spec.ForProvider.SecurityPolicies.Firewall.Association.Domain); i6++ {
					{
						...
						rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
							CurrentValue: ptr.Deref(mg.Spec.ForProvider.SecurityPolicies.Firewall.Association.Domain[i6].CdnFrontdoorDomainID, ""),
							Extract:      resource.ExtractResourceID(),
					...
					mg.Spec.ForProvider.SecurityPolicies.Firewall.Association.Domain[i6].CdnFrontdoorDomainID = ptr.To(rsp.ResolvedValue)
		...
		if mg.Spec.ForProvider.SecurityPolicies.Firewall != nil {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.SecurityPolicies.Firewall.CdnFrontdoorFirewallPolicyID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.SecurityPolicies.Firewall.CdnFrontdoorFirewallPolicyID = ptr.To(rsp.ResolvedValue)
				...
				for i6 := 0; i6 < len(mg.Spec.InitProvider.SecurityPolicies.Firewall.Association.Domain); i6++ {
					{
						...
						rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
							CurrentValue: ptr.Deref(mg.Spec.InitProvider.SecurityPolicies.Firewall.Association.Domain[i6].CdnFrontdoorDomainID, ""),
							Extract:      resource.ExtractResourceID(),
					...
					mg.Spec.InitProvider.SecurityPolicies.Firewall.Association.Domain[i6].CdnFrontdoorDomainID = ptr.To(rsp.ResolvedValue)
		...
		if mg.Spec.InitProvider.SecurityPolicies.Firewall != nil {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.SecurityPolicies.Firewall.CdnFrontdoorFirewallPolicyID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.SecurityPolicies.Firewall.CdnFrontdoorFirewallPolicyID = ptr.To(rsp.ResolvedValue)
