...
// ConvertTo converts this CloudElasticsearch to the hub type.
func (tr *CloudElasticsearch) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the CloudElasticsearch type.
func (tr *CloudElasticsearch) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
