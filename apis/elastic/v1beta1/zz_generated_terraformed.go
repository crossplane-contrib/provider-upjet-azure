...
// SetInitParameters for this CloudElasticsearch
func (tr *CloudElasticsearch) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this CloudElasticsearch using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CloudElasticsearch) LateInitialize(attrs []byte) (bool, error) {
	params := &CloudElasticsearchParameters{}
