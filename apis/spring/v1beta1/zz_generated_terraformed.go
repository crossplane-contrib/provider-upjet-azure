...
// SetInitParameters for this CloudApplicationLiveView
func (tr *CloudApplicationLiveView) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this CloudApplicationLiveView using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CloudApplicationLiveView) LateInitialize(attrs []byte) (bool, error) {
	params := &CloudApplicationLiveViewParameters{}
