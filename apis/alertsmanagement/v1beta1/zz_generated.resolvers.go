	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Scope); i3++ {
		{
			...
			mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
				CurrentValues: helper.FromPtrValues(mg.Spec.ForProvider.Scope[i3].ResourceIds),
				Extract:       resource.ExtractResourceID(),
		...
		if err != nil {
			return errors.Wrap(err, "mg.Spec.ForProvider.Scope[i3].ResourceIds")
		}
		mg.Spec.ForProvider.Scope[i3].ResourceIds = helper.ToPtrValues(mrsp.ResolvedValues)
		mg.Spec.ForProvider.Scope[i3].ResourceIdsRefs = mrsp.ResolvedReferences
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Scope); i3++ {
		{
			...
			mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
				CurrentValues: helper.FromPtrValues(mg.Spec.InitProvider.Scope[i3].ResourceIds),
				Extract:       resource.ExtractResourceID(),
		...
		if err != nil {
			return errors.Wrap(err, "mg.Spec.InitProvider.Scope[i3].ResourceIds")
		}
		mg.Spec.InitProvider.Scope[i3].ResourceIds = helper.ToPtrValues(mrsp.ResolvedValues)
		mg.Spec.InitProvider.Scope[i3].ResourceIdsRefs = mrsp.ResolvedReferences
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.ActionGroup); i3++ {
		{
			...
			mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
				CurrentValues: helper.FromPtrValues(mg.Spec.ForProvider.ActionGroup[i3].Ids),
				Extract:       rconfig.ExtractResourceID(),
		...
		mg.Spec.ForProvider.ActionGroup[i3].Ids = helper.ToPtrValues(mrsp.ResolvedValues)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.ActionGroup); i3++ {
		{
			...
			mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
				CurrentValues: helper.FromPtrValues(mg.Spec.InitProvider.ActionGroup[i3].Ids),
				Extract:       rconfig.ExtractResourceID(),
		...
		mg.Spec.InitProvider.ActionGroup[i3].Ids = helper.ToPtrValues(mrsp.ResolvedValues)
