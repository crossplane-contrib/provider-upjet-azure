...
func (in *MonitorActionRuleSuppressionConditionInitParameters) DeepCopyInto(out *MonitorActionRuleSuppressionConditionInitParameters) {
	*out = *in
	...
	if in.Monitor != nil {
		in, out := &in.Monitor, &out.Monitor
		*out = make([]ConditionMonitorInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorActionRuleSuppressionConditionObservation) DeepCopyInto(out *MonitorActionRuleSuppressionConditionObservation) {
	*out = *in
	...
	if in.Monitor != nil {
		in, out := &in.Monitor, &out.Monitor
		*out = make([]ConditionMonitorObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorActionRuleSuppressionInitParameters) DeepCopyInto(out *MonitorActionRuleSuppressionInitParameters) {
	*out = *in
	if in.Condition != nil {
		in, out := &in.Condition, &out.Condition
		*out = make([]MonitorActionRuleSuppressionConditionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Scope != nil {
		in, out := &in.Scope, &out.Scope
		*out = make([]MonitorActionRuleSuppressionScopeInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorActionRuleSuppressionObservation) DeepCopyInto(out *MonitorActionRuleSuppressionObservation) {
	*out = *in
	if in.Condition != nil {
		in, out := &in.Condition, &out.Condition
		*out = make([]MonitorActionRuleSuppressionConditionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Scope != nil {
		in, out := &in.Scope, &out.Scope
		*out = make([]MonitorActionRuleSuppressionScopeObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorAlertProcessingRuleActionGroupConditionInitParameters) DeepCopyInto(out *MonitorAlertProcessingRuleActionGroupConditionInitParameters) {
	*out = *in
	if in.AlertContext != nil {
		in, out := &in.AlertContext, &out.AlertContext
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionAlertContextInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AlertRuleID != nil {
		in, out := &in.AlertRuleID, &out.AlertRuleID
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionAlertRuleIDInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Description != nil {
		in, out := &in.Description, &out.Description
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionDescriptionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.MonitorService != nil {
		in, out := &in.MonitorService, &out.MonitorService
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionMonitorServiceInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Severity != nil {
		in, out := &in.Severity, &out.Severity
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionSeverityInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TargetResourceType != nil {
		in, out := &in.TargetResourceType, &out.TargetResourceType
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionTargetResourceTypeInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorAlertProcessingRuleActionGroupConditionObservation) DeepCopyInto(out *MonitorAlertProcessingRuleActionGroupConditionObservation) {
	*out = *in
	if in.AlertContext != nil {
		in, out := &in.AlertContext, &out.AlertContext
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionAlertContextObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AlertRuleID != nil {
		in, out := &in.AlertRuleID, &out.AlertRuleID
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionAlertRuleIDObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Description != nil {
		in, out := &in.Description, &out.Description
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionDescriptionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.MonitorService != nil {
		in, out := &in.MonitorService, &out.MonitorService
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionMonitorServiceObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Severity != nil {
		in, out := &in.Severity, &out.Severity
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionSeverityObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TargetResourceType != nil {
		in, out := &in.TargetResourceType, &out.TargetResourceType
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionTargetResourceTypeObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorAlertProcessingRuleActionGroupInitParameters) DeepCopyInto(out *MonitorAlertProcessingRuleActionGroupInitParameters) {
	*out = *in
	...
	if in.Condition != nil {
		in, out := &in.Condition, &out.Condition
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Schedule != nil {
		...
		*out = make([]MonitorAlertProcessingRuleActionGroupScheduleInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorAlertProcessingRuleActionGroupObservation) DeepCopyInto(out *MonitorAlertProcessingRuleActionGroupObservation) {
	*out = *in
	...
	if in.Condition != nil {
		in, out := &in.Condition, &out.Condition
		*out = make([]MonitorAlertProcessingRuleActionGroupConditionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Schedule != nil {
		in, out := &in.Schedule, &out.Schedule
		*out = make([]MonitorAlertProcessingRuleActionGroupScheduleObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorAlertProcessingRuleSuppressionConditionInitParameters) DeepCopyInto(out *MonitorAlertProcessingRuleSuppressionConditionInitParameters) {
	*out = *in
	if in.AlertContext != nil {
		in, out := &in.AlertContext, &out.AlertContext
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionAlertContextInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AlertRuleID != nil {
		in, out := &in.AlertRuleID, &out.AlertRuleID
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionAlertRuleIDInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Description != nil {
		in, out := &in.Description, &out.Description
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionDescriptionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.MonitorService != nil {
		in, out := &in.MonitorService, &out.MonitorService
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionMonitorServiceInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Severity != nil {
		in, out := &in.Severity, &out.Severity
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionSeverityInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TargetResourceType != nil {
		in, out := &in.TargetResourceType, &out.TargetResourceType
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionTargetResourceTypeInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MonitorAlertProcessingRuleSuppressionConditionObservation) DeepCopyInto(out *MonitorAlertProcessingRuleSuppressionConditionObservation) {
	*out = *in
	if in.AlertContext != nil {
		in, out := &in.AlertContext, &out.AlertContext
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionAlertContextObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AlertRuleID != nil {
		in, out := &in.AlertRuleID, &out.AlertRuleID
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionAlertRuleIDObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Description != nil {
		in, out := &in.Description, &out.Description
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionDescriptionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.MonitorService != nil {
		in, out := &in.MonitorService, &out.MonitorService
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionMonitorServiceObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Severity != nil {
		in, out := &in.Severity, &out.Severity
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionSeverityObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TargetResourceType != nil {
		in, out := &in.TargetResourceType, &out.TargetResourceType
		*out = make([]MonitorAlertProcessingRuleSuppressionConditionTargetResourceTypeObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
