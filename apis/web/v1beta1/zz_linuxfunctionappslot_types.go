...
type LinuxFunctionAppSlotObservation struct {
	...
	SiteCredential []LinuxFunctionAppSlotSiteCredentialObservation `json:"siteCredential,omitempty" tf:"site_credential,omitempty"`
}
...
type LinuxFunctionAppSlotParameters struct {
	...
	// a site_config block as detailed below.
	// +kubebuilder:validation:Required
	SiteConfig []LinuxFunctionAppSlotSiteConfigParameters `json:"siteConfig" tf:"site_config,omitempty"`
...
type LinuxFunctionAppSlotSiteConfigIPRestrictionParameters struct {
	...
	// +kubebuilder:validation:Optional
	Headers []LinuxFunctionAppSlotSiteConfigIPRestrictionHeadersParameters `json:"headers,omitempty" tf:"headers"`
...
type LinuxFunctionAppSlotSiteConfigScmIPRestrictionParameters struct {
	...
	// a headers block as detailed below.
	// +kubebuilder:validation:Optional
	Headers []LinuxFunctionAppSlotSiteConfigScmIPRestrictionHeadersParameters `json:"headers,omitempty" tf:"headers"`
