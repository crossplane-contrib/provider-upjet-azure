...
type WindowsFunctionAppAuthSettingsV2Parameters struct {
	...
	// A login block as defined below.
	Login []WindowsFunctionAppAuthSettingsV2LoginParameters `json:"login,omitempty" tf:"login,omitempty"`
...
type WindowsFunctionAppBackupParameters struct {
	...
	// A schedule block as defined below.
	Schedule []WindowsFunctionAppBackupScheduleParameters `json:"schedule,omitempty" tf:"schedule,omitempty"`
