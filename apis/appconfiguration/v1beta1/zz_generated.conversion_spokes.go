...
// ConvertTo converts this Configuration to the hub type.
func (tr *Configuration) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Configuration type.
func (tr *Configuration) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
