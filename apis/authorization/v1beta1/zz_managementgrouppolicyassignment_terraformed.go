...
func (tr *ManagementGroupPolicyAssignment) GetObservation() (map[string]any, error) {
...
func (tr *ManagementGroupPolicyAssignment) SetObservation(obs map[string]any) error {
...
func (tr *ManagementGroupPolicyAssignment) GetParameters() (map[string]any, error) {
...
func (tr *ManagementGroupPolicyAssignment) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ManagementGroupPolicyAssignment
func (tr *ManagementGroupPolicyAssignment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ManagementGroupPolicyAssignment
func (tr *ManagementGroupPolicyAssignment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
