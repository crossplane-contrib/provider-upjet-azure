...
func (mg *DomainTopic) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("eventgrid.azure.upbound.io", "v1beta2", "Domain", "DomainList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}

		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			CurrentValue: ptr.Deref(mg.Spec.ForProvider.DomainName, ""),
			Extract:      reference.ExternalName(),
	...
	mg.Spec.ForProvider.DomainName = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.StorageQueueEndpoint); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.StorageQueueEndpoint[i3].QueueName, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.ForProvider.StorageQueueEndpoint[i3].QueueName = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.StorageQueueEndpoint); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.StorageQueueEndpoint[i3].StorageAccountID, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.ForProvider.StorageQueueEndpoint[i3].StorageAccountID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.StorageQueueEndpoint); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.StorageQueueEndpoint[i3].QueueName, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.InitProvider.StorageQueueEndpoint[i3].QueueName = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.StorageQueueEndpoint); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.StorageQueueEndpoint[i3].StorageAccountID, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.InitProvider.StorageQueueEndpoint[i3].StorageAccountID = ptr.To(rsp.ResolvedValue)
