...
// ConvertTo converts this Gen2Environment to the hub type.
func (tr *Gen2Environment) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Gen2Environment type.
func (tr *Gen2Environment) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
