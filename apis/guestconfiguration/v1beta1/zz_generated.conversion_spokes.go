...
// ConvertTo converts this PolicyVirtualMachineConfigurationAssignment to the hub type.
func (tr *PolicyVirtualMachineConfigurationAssignment) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the PolicyVirtualMachineConfigurationAssignment type.
func (tr *PolicyVirtualMachineConfigurationAssignment) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
