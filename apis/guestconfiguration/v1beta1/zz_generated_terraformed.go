...
// SetInitParameters for this PolicyVirtualMachineConfigurationAssignment
func (tr *PolicyVirtualMachineConfigurationAssignment) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
