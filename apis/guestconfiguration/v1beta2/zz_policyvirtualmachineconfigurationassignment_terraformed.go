//go:build (guestconfiguration || all) && !ignore_autogenerated
...
func (tr *PolicyVirtualMachineConfigurationAssignment) GetObservation() (map[string]any, error) {
...
func (tr *PolicyVirtualMachineConfigurationAssignment) SetObservation(obs map[string]any) error {
...
func (tr *PolicyVirtualMachineConfigurationAssignment) GetParameters() (map[string]any, error) {
...
func (tr *PolicyVirtualMachineConfigurationAssignment) SetParameters(params map[string]any) error {
...
// GetInitParameters of this PolicyVirtualMachineConfigurationAssignment
func (tr *PolicyVirtualMachineConfigurationAssignment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PolicyVirtualMachineConfigurationAssignment
func (tr *PolicyVirtualMachineConfigurationAssignment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
