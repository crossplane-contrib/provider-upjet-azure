...
func (mg *PolicyVirtualMachineConfigurationAssignment) ResolveReferences( // ResolveReferences of this PolicyVirtualMachineConfigurationAssignment.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.azure.upbound.io", "v1beta2", "WindowsVirtualMachine", "WindowsVirtualMachineList")
		if err != nil {
