...
// SetInitParameters for this DiskPool
func (tr *DiskPool) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this DiskPool using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DiskPool) LateInitialize(attrs []byte) (bool, error) {
	params := &DiskPoolParameters{}
