...
type DesktopHostPoolInitParameters struct {
...
type DesktopHostPoolSpec struct {
	...
	// autoscaler.
	InitProvider DesktopHostPoolInitParameters `json:"initProvider,omitempty"`
}
...
// DesktopHostPool is the Schema for the DesktopHostPools API. Manages a Virtual Desktop Host Pool.
...
var (
	DesktopHostPool_Kind             = "DesktopHostPool"
	DesktopHostPool_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DesktopHostPool_Kind}.String()
	DesktopHostPool_KindAPIVersion   = DesktopHostPool_Kind + "." + CRDGroupVersion.String()
	DesktopHostPool_GroupVersionKind = CRDGroupVersion.WithKind(DesktopHostPool_Kind)
)
