...
type ResourceGroupPolicyAssignmentIdentityInitParameters struct {
...
type ResourceGroupPolicyAssignmentIdentityObservation struct {
...
type ResourceGroupPolicyAssignmentIdentityParameters struct {
...
type ResourceGroupPolicyAssignmentInitParameters struct {
	...
	Identity *ResourceGroupPolicyAssignmentIdentityInitParameters `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	NonComplianceMessage []ResourceGroupPolicyAssignmentNonComplianceMessageInitParameters `json:"nonComplianceMessage,omitempty" tf:"non_compliance_message,omitempty"`
	...
	Overrides []ResourceGroupPolicyAssignmentOverridesInitParameters `json:"overrides,omitempty" tf:"overrides,omitempty"`

	// A JSON mapping of any Parameters for this Policy.
	Parameters *string `json:"parameters,omitempty" tf:"parameters,omitempty"`

	// The ID of the Policy Definition or Policy Definition Set. Changing this forces a new Policy Assignment to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/authorization/v1beta1.PolicyDefinition
...
type ResourceGroupPolicyAssignmentNonComplianceMessageInitParameters struct {
...
type ResourceGroupPolicyAssignmentNonComplianceMessageObservation struct {
...
type ResourceGroupPolicyAssignmentNonComplianceMessageParameters struct {
...
type ResourceGroupPolicyAssignmentObservation struct {
	...
	// An identity block as defined below.
	Identity *ResourceGroupPolicyAssignmentIdentityObservation `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	// One or more non_compliance_message blocks as defined below.
	NonComplianceMessage []ResourceGroupPolicyAssignmentNonComplianceMessageObservation `json:"nonComplianceMessage,omitempty" tf:"non_compliance_message,omitempty"`

	// Specifies a list of Resource Scopes (for example a Subscription, or a Resource Group) within this Management Group which are excluded from this Policy.
	NotScopes []*string `json:"notScopes,omitempty" tf:"not_scopes,omitempty"`

	// One or more overrides blocks as defined below. More detail about overrides and resource_selectors see policy assignment structure
	Overrides []ResourceGroupPolicyAssignmentOverridesObservation `json:"overrides,omitempty" tf:"overrides,omitempty"`
	...
	// One or more resource_selectors blocks as defined below to filter polices by resource properties.
	ResourceSelectors []ResourceGroupPolicyAssignmentResourceSelectorsObservation `json:"resourceSelectors,omitempty" tf:"resource_selectors,omitempty"`
}

type ResourceGroupPolicyAssignmentOverridesInitParameters struct {
...
type ResourceGroupPolicyAssignmentOverridesObservation struct {
...
type ResourceGroupPolicyAssignmentOverridesParameters struct {
...
type ResourceGroupPolicyAssignmentParameters struct {
	...
	// An identity block as defined below.
	// +kubebuilder:validation:Optional
	Identity *ResourceGroupPolicyAssignmentIdentityParameters `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	// One or more non_compliance_message blocks as defined below.
	// +kubebuilder:validation:Optional
	NonComplianceMessage []ResourceGroupPolicyAssignmentNonComplianceMessageParameters `json:"nonComplianceMessage,omitempty" tf:"non_compliance_message,omitempty"`
	...
	// One or more overrides blocks as defined below. More detail about overrides and resource_selectors see policy assignment structure
	// +kubebuilder:validation:Optional
	Overrides []ResourceGroupPolicyAssignmentOverridesParameters `json:"overrides,omitempty" tf:"overrides,omitempty"`
	...
	// One or more resource_selectors blocks as defined below to filter polices by resource properties.
	// +kubebuilder:validation:Optional
	ResourceSelectors []ResourceGroupPolicyAssignmentResourceSelectorsParameters `json:"resourceSelectors,omitempty" tf:"resource_selectors,omitempty"`
}

type ResourceGroupPolicyAssignmentResourceSelectorsInitParameters struct {

	// Specifies a name for the resource selector.
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// One or more resource_selector block as defined below.
	Selectors []ResourceGroupPolicyAssignmentResourceSelectorsSelectorsInitParameters `json:"selectors,omitempty" tf:"selectors,omitempty"`
}

type ResourceGroupPolicyAssignmentResourceSelectorsObservation struct {

	// Specifies a name for the resource selector.
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// One or more resource_selector block as defined below.
	Selectors []ResourceGroupPolicyAssignmentResourceSelectorsSelectorsObservation `json:"selectors,omitempty" tf:"selectors,omitempty"`
}

type ResourceGroupPolicyAssignmentResourceSelectorsParameters struct {
	...
	// One or more resource_selector block as defined below.
	// +kubebuilder:validation:Optional
	Selectors []ResourceGroupPolicyAssignmentResourceSelectorsSelectorsParameters `json:"selectors" tf:"selectors,omitempty"`
}

type ResourceGroupPolicyAssignmentResourceSelectorsSelectorsInitParameters struct {
...
type ResourceGroupPolicyAssignmentResourceSelectorsSelectorsObservation struct {
...
type ResourceGroupPolicyAssignmentResourceSelectorsSelectorsParameters struct {
