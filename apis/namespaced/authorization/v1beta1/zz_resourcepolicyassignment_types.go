...
type ResourcePolicyAssignmentOverridesInitParameters struct {
	...
	Selectors []ResourcePolicyAssignmentOverridesSelectorsInitParameters `json:"selectors,omitempty" tf:"selectors,omitempty"`
...
type ResourcePolicyAssignmentOverridesObservation struct {
	...
	// One or more override_selector block as defined below.
	Selectors []ResourcePolicyAssignmentOverridesSelectorsObservation `json:"selectors,omitempty" tf:"selectors,omitempty"`
...
type ResourcePolicyAssignmentOverridesParameters struct {
	...
	// One or more override_selector block as defined below.
	// +kubebuilder:validation:Optional
	Selectors []ResourcePolicyAssignmentOverridesSelectorsParameters `json:"selectors,omitempty" tf:"selectors,omitempty"`
...
type ResourcePolicyAssignmentOverridesSelectorsInitParameters struct {
...
type ResourcePolicyAssignmentOverridesSelectorsObservation struct {
...
type ResourcePolicyAssignmentOverridesSelectorsParameters struct {
