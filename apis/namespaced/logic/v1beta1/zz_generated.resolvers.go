...
func (mg *AppActionCustom) ResolveReferences( // ResolveReferences of this AppActionCustom.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("logic.azure.m.upbound.io", "v1beta1", "AppWorkflow", "AppWorkflowList")
		if err != nil {
...
func (mg *AppIntegrationAccountBatchConfiguration) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("logic.azure.m.upbound.io", "v1beta1", "AppIntegrationAccount", "AppIntegrationAccountList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
