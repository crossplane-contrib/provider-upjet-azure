...
type SystemTopicInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceArmResourceIDRef *v2.NamespacedReference `json:"sourceArmResourceIdRef,omitempty" tf:"-"`

	// Selector for a Account in storage to populate sourceArmResourceId.
	// +kubebuilder:validation:Optional
	SourceArmResourceIDSelector *v2.NamespacedSelector `json:"sourceArmResourceIdSelector,omitempty" tf:"-"`
