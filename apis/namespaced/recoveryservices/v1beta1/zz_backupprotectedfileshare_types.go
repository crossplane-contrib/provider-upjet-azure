...
type BackupProtectedFileShareInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceFileShareNameRef *v2.NamespacedReference `json:"sourceFileShareNameRef,omitempty" tf:"-"`

	// Selector for a Share in storage to populate sourceFileShareName.
	// +kubebuilder:validation:Optional
	SourceFileShareNameSelector *v2.NamespacedSelector `json:"sourceFileShareNameSelector,omitempty" tf:"-"`
