...
func (mg *HealthBot) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this HealthBot.
func (mg *HealthBot) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *HealthBot) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this HealthBot.
func (mg *HealthBot) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
