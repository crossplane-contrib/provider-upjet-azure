...
type WorkspaceOutboundRulePrivateEndpointInitParameters struct {
	...
	ServiceResourceIDRef *v2.NamespacedReference `json:"serviceResourceIdRef,omitempty" tf:"-"`

	// Selector for a Account in storage to populate serviceResourceId.
	// +kubebuilder:validation:Optional
	ServiceResourceIDSelector *v2.NamespacedSelector `json:"serviceResourceIdSelector,omitempty" tf:"-"`
