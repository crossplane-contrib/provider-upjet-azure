...
type WorkspaceOutboundRulePrivateEndpointInitParameters struct {
	...
	ServiceResourceIDRef *v1.NamespacedReference `json:"serviceResourceIdRef,omitempty" tf:"-"`

	// Selector for a Account in storage to populate serviceResourceId.
	// +kubebuilder:validation:Optional
	ServiceResourceIDSelector *v1.NamespacedSelector `json:"serviceResourceIdSelector,omitempty" tf:"-"`
