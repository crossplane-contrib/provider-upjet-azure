...
type SnapshotEncryptionSettingsParameters struct {
	...
	// A disk_encryption_key block as defined below.
	// +kubebuilder:validation:Optional
	DiskEncryptionKey *EncryptionSettingsDiskEncryptionKeyParameters `json:"diskEncryptionKey" tf:"disk_encryption_key,omitempty"`
...
type SnapshotInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceURIRef *v1.NamespacedReference `json:"sourceUriRef,omitempty" tf:"-"`

	// Selector for a ManagedDisk in compute to populate sourceUri.
	// +kubebuilder:validation:Optional
	SourceURISelector *v1.NamespacedSelector `json:"sourceUriSelector,omitempty" tf:"-"`
