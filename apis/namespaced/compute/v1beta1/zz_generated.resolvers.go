...
func (mg *CapacityReservation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.azure.m.upbound.io", "v1beta1", "CapacityReservationGroup", "CapacityReservationGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *GalleryApplication) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.azure.m.upbound.io", "v1beta1", "SharedImageGallery", "SharedImageGalleryList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *GalleryApplicationVersion) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.azure.m.upbound.io", "v1beta1", "GalleryApplication", "GalleryApplicationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	if mg.Spec.ForProvider.Source != nil {
		{
			m, l, err = apisresolver.GetManagedResource("storage.azure.m.upbound.io", "v1beta1", "Blob", "BlobList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
...
func (mg *ManagedDisk) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.ResourceGroupNameRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.azure.m.upbound.io", "v1beta1", "ManagedDisk", "ManagedDiskList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
// ResolveReferences of this VirtualMachineScaleSetStandbyPool.
func (mg *VirtualMachineScaleSetStandbyPool) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.azure.m.upbound.io", "v1beta1", "OrchestratedVirtualMachineScaleSet", "OrchestratedVirtualMachineScaleSetList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}

		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.AttachedVirtualMachineScaleSetID),
			Extract:      rconfig.ExtractResourceID(),
			Namespace:    mg.GetNamespace(),
			Reference:    mg.Spec.ForProvider.AttachedVirtualMachineScaleSetIDRef,
			Selector:     mg.Spec.ForProvider.AttachedVirtualMachineScaleSetIDSelector,
			To:           reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.AttachedVirtualMachineScaleSetID")
	}
	mg.Spec.ForProvider.AttachedVirtualMachineScaleSetID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.AttachedVirtualMachineScaleSetIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("azure.m.upbound.io", "v1beta1", "ResourceGroup", "ResourceGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
	...
	mg.Spec.ForProvider.ResourceGroupNameRef = rsp.ResolvedReference
	{
		...
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.AttachedVirtualMachineScaleSetID),
			Extract:      rconfig.ExtractResourceID(),
			Namespace:    mg.GetNamespace(),
			Reference:    mg.Spec.InitProvider.AttachedVirtualMachineScaleSetIDRef,
			Selector:     mg.Spec.InitProvider.AttachedVirtualMachineScaleSetIDSelector,
			To:           reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.AttachedVirtualMachineScaleSetID")
	}
	mg.Spec.InitProvider.AttachedVirtualMachineScaleSetID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.AttachedVirtualMachineScaleSetIDRef = rsp.ResolvedReference
