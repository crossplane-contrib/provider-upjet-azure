...
// GetInitParameters of this AccountCustomerManagedKey
func (tr *AccountCustomerManagedKey) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AccountCustomerManagedKey
func (tr *AccountCustomerManagedKey) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *AccountCustomerManagedKey) LateInitialize(attrs []byte) (bool, error) {
	params := &AccountCustomerManagedKeyParameters_2{}
