...
type BackupPolicyDiskInitParameters struct {
	...
	RetentionRule []BackupPolicyDiskRetentionRuleInitParameters `json:"retentionRule,omitempty" tf:"retention_rule,omitempty"`
...
type BackupPolicyDiskObservation struct {
	...
	// One or more retention_rule blocks as defined below. Changing this forces a new Backup Policy Disk to be created.
	RetentionRule []BackupPolicyDiskRetentionRuleObservation `json:"retentionRule,omitempty" tf:"retention_rule,omitempty"`
...
type BackupPolicyDiskParameters struct {
	...
	// One or more retention_rule blocks as defined below. Changing this forces a new Backup Policy Disk to be created.
	// +kubebuilder:validation:Optional
	RetentionRule []BackupPolicyDiskRetentionRuleParameters `json:"retentionRule,omitempty" tf:"retention_rule,omitempty"`
...
type BackupPolicyDiskRetentionRuleObservation struct {
...
type BackupPolicyDiskRetentionRuleParameters struct {
