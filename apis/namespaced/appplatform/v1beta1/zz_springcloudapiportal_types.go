...
type SpringCloudAPIPortalInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/appplatform/v1beta1.SpringCloudGateway
	...
	GatewayIdsRefs []v1.NamespacedReference `json:"gatewayIdsRefs,omitempty" tf:"-"`

	// Selector for a list of SpringCloudGateway in appplatform to populate gatewayIds.
	// +kubebuilder:validation:Optional
	GatewayIdsSelector *v1.NamespacedSelector `json:"gatewayIdsSelector,omitempty" tf:"-"`
