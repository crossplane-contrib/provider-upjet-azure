...
type CertificateInitParameters struct {
	...
	EncodedCertificateSecretRef v1.LocalSecretKeySelector `json:"encodedCertificateSecretRef" tf:"-"`
...
type DelegationInitParameters struct {
	...
	ValidationKeySecretRef *v1.LocalSecretKeySelector `json:"validationKeySecretRef,omitempty" tf:"-"`
}
