...
type CertificateInitParameters struct {
	...
	EncodedCertificateSecretRef v2.LocalSecretKeySelector `json:"encodedCertificateSecretRef" tf:"-"`
...
type DelegationInitParameters struct {
	...
	ValidationKeySecretRef *v2.LocalSecretKeySelector `json:"validationKeySecretRef,omitempty" tf:"-"`
}
