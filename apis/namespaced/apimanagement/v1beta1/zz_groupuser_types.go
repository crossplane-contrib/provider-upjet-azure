...
type GroupUserObservation struct {
	...
	// The ID of the API Management Group User.
...
type GroupUserParameters struct {
	...
	// The Name of the API Management Group within the API Management Service. Changing this forces a new resource to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/apimanagement/v1beta1.Group
	// +kubebuilder:validation:Optional
	GroupName *string `json:"groupName,omitempty" tf:"group_name,omitempty"`
	...
	// The ID of the API Management User which should be assigned to this API Management Group. Changing this forces a new resource to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/apimanagement/v1beta1.User
	// +kubebuilder:validation:Optional
	UserID *string `json:"userId,omitempty" tf:"user_id,omitempty"`
...
type GroupUserSpec struct {
	...
	// autoscaler.
	InitProvider GroupUserInitParameters `json:"initProvider,omitempty"`
}
...
// GroupUser is the Schema for the GroupUsers API. Manages an API Management User Assignment to a Group.
...
type GroupUser struct {
	...
	Spec              GroupUserSpec   `json:"spec"`
	Status            GroupUserStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GroupUserList contains a list of GroupUsers
...
var (
	GroupUser_Kind             = "GroupUser"
	GroupUser_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GroupUser_Kind}.String()
	GroupUser_KindAPIVersion   = GroupUser_Kind + "." + CRDGroupVersion.String()
	GroupUser_GroupVersionKind = CRDGroupVersion.WithKind(GroupUser_Kind)
)

func init() {
	SchemeBuilder.Register(&GroupUser{}, &GroupUserList{})
}
