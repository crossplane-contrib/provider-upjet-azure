...
type MonitorScheduledQueryRulesAlertV2ActionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ActionGroupsRefs []v2.NamespacedReference `json:"actionGroupsRefs,omitempty" tf:"-"`

	// Selector for a list of MonitorActionGroup in insights to populate actionGroups.
	// +kubebuilder:validation:Optional
	ActionGroupsSelector *v2.NamespacedSelector `json:"actionGroupsSelector,omitempty" tf:"-"`
