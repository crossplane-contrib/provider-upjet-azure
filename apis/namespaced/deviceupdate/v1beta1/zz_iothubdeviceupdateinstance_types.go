...
type IOTHubDeviceUpdateInstanceParameters struct {
	...
	// +kubebuilder:validation:Optional
	DeviceUpdateAccountIDRef *v2.NamespacedReference `json:"deviceUpdateAccountIdRef,omitempty" tf:"-"`

	// Selector for a IOTHubDeviceUpdateAccount in deviceupdate to populate deviceUpdateAccountId.
	// +kubebuilder:validation:Optional
	DeviceUpdateAccountIDSelector *v2.NamespacedSelector `json:"deviceUpdateAccountIdSelector,omitempty" tf:"-"`
