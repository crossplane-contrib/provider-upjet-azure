...
type AutonomousDatabaseCloneFromDatabaseInitParameters struct {
	...
	RefreshableModel *string `json:"refreshableModel,omitempty" tf:"refreshable_model,omitempty"`
...
type AutonomousDatabaseCloneFromDatabaseObservation struct {
	...
	// The ID of the autonomous database cloned from a database.
...
type AutonomousDatabaseCloneFromDatabaseParameters struct {
...
type AutonomousDatabaseCloneFromDatabaseSpec struct {
	...
	// autoscaler.
	InitProvider AutonomousDatabaseCloneFromDatabaseInitParameters `json:"initProvider,omitempty"`
}
...
// AutonomousDatabaseCloneFromDatabase is the Schema for the AutonomousDatabaseCloneFromDatabases API. Manages an autonomous database clone from database.
...
type AutonomousDatabaseCloneFromDatabase struct {
	...
	Spec   AutonomousDatabaseCloneFromDatabaseSpec   `json:"spec"`
	Status AutonomousDatabaseCloneFromDatabaseStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AutonomousDatabaseCloneFromDatabaseList contains a list of AutonomousDatabaseCloneFromDatabases
type AutonomousDatabaseCloneFromDatabaseList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AutonomousDatabaseCloneFromDatabase `json:"items"`
}

// Repository type metadata.
var (
	AutonomousDatabaseCloneFromDatabase_Kind             = "AutonomousDatabaseCloneFromDatabase"
	AutonomousDatabaseCloneFromDatabase_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AutonomousDatabaseCloneFromDatabase_Kind}.String()
	AutonomousDatabaseCloneFromDatabase_KindAPIVersion   = AutonomousDatabaseCloneFromDatabase_Kind + "." + CRDGroupVersion.String()
	AutonomousDatabaseCloneFromDatabase_GroupVersionKind = CRDGroupVersion.WithKind(AutonomousDatabaseCloneFromDatabase_Kind)
)

func init() {
	SchemeBuilder.Register(&AutonomousDatabaseCloneFromDatabase{}, &AutonomousDatabaseCloneFromDatabaseList{})
}
