...
type HybridConnectionInitParameters struct {
	...
	RelayNamespaceNameRef *v2.NamespacedReference `json:"relayNamespaceNameRef,omitempty" tf:"-"`

	// Selector for a EventRelayNamespace in relay to populate relayNamespaceName.
	// +kubebuilder:validation:Optional
	RelayNamespaceNameSelector *v2.NamespacedSelector `json:"relayNamespaceNameSelector,omitempty" tf:"-"`
