...
type SQLPoolWorkloadGroupParameters struct {
	...
	// The ID of the Synapse SQL Pool. Changing this forces a new Synapse SQL Pool Workload Group to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/synapse/v1beta1.SQLPool
	...
	// +kubebuilder:validation:Optional
	SQLPoolIDRef *v1.NamespacedReference `json:"sqlPoolIdRef,omitempty" tf:"-"`

	// Selector for a SQLPool in synapse to populate sqlPoolId.
	// +kubebuilder:validation:Optional
	SQLPoolIDSelector *v1.NamespacedSelector `json:"sqlPoolIdSelector,omitempty" tf:"-"`
}
