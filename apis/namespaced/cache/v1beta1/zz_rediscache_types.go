...
type RedisConfigurationInitParameters struct {
	...
	AofStorageConnectionString0SecretRef *v1.LocalSecretKeySelector `json:"aofStorageConnectionString0SecretRef,omitempty" tf:"-"`

	// Second Storage Account connection string for AOF persistence.
	AofStorageConnectionString1SecretRef *v1.LocalSecretKeySelector `json:"aofStorageConnectionString1SecretRef,omitempty" tf:"-"`
	...
	RdbStorageConnectionStringSecretRef *v1.LocalSecretKeySelector `json:"rdbStorageConnectionStringSecretRef,omitempty" tf:"-"`
