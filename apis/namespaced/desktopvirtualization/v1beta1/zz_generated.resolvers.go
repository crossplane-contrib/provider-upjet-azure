...
func (mg *VirtualDesktopApplicationGroup) ResolveReferences( // ResolveReferences of this VirtualDesktopApplicationGroup.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("desktopvirtualization.azure.m.upbound.io", "v1beta1", "VirtualDesktopHostPool", "VirtualDesktopHostPoolList")
		if err != nil {
...
func (mg *VirtualDesktopWorkspaceAppplicationGroupAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("desktopvirtualization.azure.m.upbound.io", "v1beta1", "VirtualDesktopApplicationGroup", "VirtualDesktopApplicationGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("desktopvirtualization.azure.m.upbound.io", "v1beta1", "VirtualDesktopWorkspace", "VirtualDesktopWorkspaceList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
