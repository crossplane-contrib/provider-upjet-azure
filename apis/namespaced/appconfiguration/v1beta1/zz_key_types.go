...
type KeyInitParameters struct {
	...
	ConfigurationStoreIDRef *v2.NamespacedReference `json:"configurationStoreIdRef,omitempty" tf:"-"`

	// Selector for a Configuration in appconfiguration to populate configurationStoreId.
	// +kubebuilder:validation:Optional
	ConfigurationStoreIDSelector *v2.NamespacedSelector `json:"configurationStoreIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	VaultKeyReferenceRef *v2.NamespacedReference `json:"vaultKeyReferenceRef,omitempty" tf:"-"`

	// Selector for a Secret in keyvault to populate vaultKeyReference.
	// +kubebuilder:validation:Optional
	VaultKeyReferenceSelector *v2.NamespacedSelector `json:"vaultKeyReferenceSelector,omitempty" tf:"-"`
}
