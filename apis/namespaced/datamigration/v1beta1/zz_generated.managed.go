...
func (mg *DatabaseMigrationProject) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this DatabaseMigrationProject.
func (mg *DatabaseMigrationProject) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *DatabaseMigrationProject) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this DatabaseMigrationProject.
func (mg *DatabaseMigrationProject) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
...
func (mg *DatabaseMigrationService) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this DatabaseMigrationService.
func (mg *DatabaseMigrationService) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}
...
func (mg *DatabaseMigrationService) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this DatabaseMigrationService.
func (mg *DatabaseMigrationService) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
	mg.Spec.WriteConnectionSecretToReference = r
}
