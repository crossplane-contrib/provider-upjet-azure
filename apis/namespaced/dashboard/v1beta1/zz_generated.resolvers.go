...
func (mg *Grafana) ResolveReferences( // ResolveReferences of this Grafana.
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.AzureMonitorWorkspaceIntegrations); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("insights.azure.m.upbound.io", "v1beta1", "MonitorWorkspace", "MonitorWorkspaceList")
			if err != nil {
...
func (mg *GrafanaManagedPrivateEndpoint) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("dashboard.azure.m.upbound.io", "v1beta1", "Grafana", "GrafanaList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
