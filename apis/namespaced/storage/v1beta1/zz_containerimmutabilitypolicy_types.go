...
type ContainerImmutabilityPolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	StorageContainerResourceManagerIDRef *v2.NamespacedReference `json:"storageContainerResourceManagerIdRef,omitempty" tf:"-"`

	// Selector for a Container in storage to populate storageContainerResourceManagerId.
	// +kubebuilder:validation:Optional
	StorageContainerResourceManagerIDSelector *v2.NamespacedSelector `json:"storageContainerResourceManagerIdSelector,omitempty" tf:"-"`
}
