...
type ContainerImmutabilityPolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	StorageContainerResourceManagerIDRef *v1.NamespacedReference `json:"storageContainerResourceManagerIdRef,omitempty" tf:"-"`

	// Selector for a Container in storage to populate storageContainerResourceManagerId.
	// +kubebuilder:validation:Optional
	StorageContainerResourceManagerIDSelector *v1.NamespacedSelector `json:"storageContainerResourceManagerIdSelector,omitempty" tf:"-"`
}
