...
type EnvironmentVariableInitParameters struct {
	...
	SecureValueSecretRef *v1.LocalSecretKeySelector `json:"secureValueSecretRef,omitempty" tf:"-"`
...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,managed,azure},path=resourcedeploymentscriptazureclicli
