...
type FunctionAppSlotAuthSettingsFacebookInitParameters struct {
	...
	AppSecretSecretRef v1.LocalSecretKeySelector `json:"appSecretSecretRef" tf:"-"`
...
type FunctionAppSlotInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/web/v1beta1.AppServicePlan
	...
	// +kubebuilder:validation:Optional
	AppServicePlanIDRef *v1.NamespacedReference `json:"appServicePlanIdRef,omitempty" tf:"-"`

	// Selector for a AppServicePlan in web to populate appServicePlanId.
	// +kubebuilder:validation:Optional
	AppServicePlanIDSelector *v1.NamespacedSelector `json:"appServicePlanIdSelector,omitempty" tf:"-"`
	...
	StorageAccountAccessKeySecretRef v1.LocalSecretKeySelector `json:"storageAccountAccessKeySecretRef" tf:"-"`
...
type FunctionAppSlotParameters struct {
	...
	// +kubebuilder:validation:Optional
	FunctionAppNameRef *v1.NamespacedReference `json:"functionAppNameRef,omitempty" tf:"-"`

	// Selector for a FunctionApp in web to populate functionAppName.
	// +kubebuilder:validation:Optional
	FunctionAppNameSelector *v1.NamespacedSelector `json:"functionAppNameSelector,omitempty" tf:"-"`
