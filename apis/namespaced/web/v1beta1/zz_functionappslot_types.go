...
type FunctionAppSlotAuthSettingsFacebookInitParameters struct {
	...
	AppSecretSecretRef v2.LocalSecretKeySelector `json:"appSecretSecretRef" tf:"-"`
...
type FunctionAppSlotInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AppServicePlanIDRef *v2.NamespacedReference `json:"appServicePlanIdRef,omitempty" tf:"-"`

	// Selector for a AppServicePlan in web to populate appServicePlanId.
	// +kubebuilder:validation:Optional
	AppServicePlanIDSelector *v2.NamespacedSelector `json:"appServicePlanIdSelector,omitempty" tf:"-"`
	...
	StorageAccountAccessKeySecretRef v2.LocalSecretKeySelector `json:"storageAccountAccessKeySecretRef" tf:"-"`
...
type FunctionAppSlotParameters struct {
	...
	// +kubebuilder:validation:Optional
	FunctionAppNameRef *v2.NamespacedReference `json:"functionAppNameRef,omitempty" tf:"-"`

	// Selector for a FunctionApp in web to populate functionAppName.
	// +kubebuilder:validation:Optional
	FunctionAppNameSelector *v2.NamespacedSelector `json:"functionAppNameSelector,omitempty" tf:"-"`
