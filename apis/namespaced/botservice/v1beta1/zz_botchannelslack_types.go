...
type BotChannelSlackInitParameters struct {
	...
	SigningSecretSecretRef *v2.LocalSecretKeySelector `json:"signingSecretSecretRef,omitempty" tf:"-"`

	// The Verification Token that will be used to authenticate with Slack.
	VerificationTokenSecretRef v2.LocalSecretKeySelector `json:"verificationTokenSecretRef" tf:"-"`
}
