...
type LogAnalyticsQueryPackQueryInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/operationalinsights/v1beta1.LogAnalyticsQueryPack
	...
	QueryPackIDRef *v1.NamespacedReference `json:"queryPackIdRef,omitempty" tf:"-"`

	// Selector for a LogAnalyticsQueryPack in operationalinsights to populate queryPackId.
	// +kubebuilder:validation:Optional
	QueryPackIDSelector *v1.NamespacedSelector `json:"queryPackIdSelector,omitempty" tf:"-"`
