...
func (tr *EnvironmentStorage) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"access_key": "accessKeySecretRef"}
}
...
// LateInitialize this EnvironmentStorage using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EnvironmentStorage) LateInitialize(attrs []byte) (bool, error) {
	params := &EnvironmentStorageParameters{}
