...
// SetInitParameters for this ContactProfile
func (tr *ContactProfile) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this ContactProfile using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ContactProfile) LateInitialize(attrs []byte) (bool, error) {
	params := &ContactProfileParameters{}
...
// SetInitParameters for this Spacecraft
func (tr *Spacecraft) SetInitParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this Spacecraft using its observed tfState.
// returns True if there are any spec changes for the resource.
