...
func (tr *PolicySetDefinition) GetObservation() (map[string]any, error) {
...
func (tr *PolicySetDefinition) SetObservation(obs map[string]any) error {
...
func (tr *PolicySetDefinition) GetParameters() (map[string]any, error) {
...
func (tr *PolicySetDefinition) SetParameters(params map[string]any) error {
...
// GetInitParameters of this PolicySetDefinition
func (tr *PolicySetDefinition) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PolicySetDefinition
func (tr *PolicySetDefinition) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
