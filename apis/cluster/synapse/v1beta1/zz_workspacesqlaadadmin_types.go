...
type WorkspaceSQLAADAdminObservation struct {
	...
	// The ID of the Synapse Workspace Azure AD SQL Administrator.
...
// WorkspaceSQLAADAdmin is the Schema for the WorkspaceSQLAADAdmins API. Manages Synapse Workspace SQL AAD Admin
