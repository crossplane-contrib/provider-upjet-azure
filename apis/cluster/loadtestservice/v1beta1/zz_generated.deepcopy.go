...
func (in *LoadTestIdentityObservation) DeepCopy() *LoadTestIdentityObservation {
	...
	out := new(LoadTestIdentityObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LoadTestIdentityParameters) DeepCopy() *LoadTestIdentityParameters {
	...
	out := new(LoadTestIdentityParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LoadTestInitParameters) DeepCopyInto(out *LoadTestInitParameters) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]LoadTestIdentityInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LoadTestObservation) DeepCopyInto(out *LoadTestObservation) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]LoadTestIdentityObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LoadTestParameters) DeepCopyInto(out *LoadTestParameters) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]LoadTestIdentityParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
