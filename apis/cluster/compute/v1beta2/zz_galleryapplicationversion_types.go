...
type GalleryApplicationVersionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/compute/v1beta1.GalleryApplication
	...
	GalleryApplicationIDRef *v2.Reference `json:"galleryApplicationIdRef,omitempty" tf:"-"`

	// Selector for a GalleryApplication in compute to populate galleryApplicationId.
	// +kubebuilder:validation:Optional
	GalleryApplicationIDSelector *v2.Selector `json:"galleryApplicationIdSelector,omitempty" tf:"-"`
...
type SourceInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	MediaLinkRef *v2.Reference `json:"mediaLinkRef,omitempty" tf:"-"`

	// Selector for a Blob in storage to populate mediaLink.
	// +kubebuilder:validation:Optional
	MediaLinkSelector *v2.Selector `json:"mediaLinkSelector,omitempty" tf:"-"`
}
