...
type VirtualDesktopHostPoolInitParameters struct {
	...
	VMTemplate *string `json:"vmTemplate,omitempty" tf:"vm_template,omitempty"`
...
type VirtualDesktopHostPoolSpec struct {
	...
	// autoscaler.
	InitProvider VirtualDesktopHostPoolInitParameters `json:"initProvider,omitempty"`
}
...
// VirtualDesktopHostPool is the Schema for the VirtualDesktopHostPools API. Manages a Virtual Desktop Host Pool.
...
var (
	VirtualDesktopHostPool_Kind             = "VirtualDesktopHostPool"
	VirtualDesktopHostPool_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualDesktopHostPool_Kind}.String()
	VirtualDesktopHostPool_KindAPIVersion   = VirtualDesktopHostPool_Kind + "." + CRDGroupVersion.String()
	VirtualDesktopHostPool_GroupVersionKind = CRDGroupVersion.WithKind(VirtualDesktopHostPool_Kind)
)
