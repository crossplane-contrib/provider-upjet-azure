...
func (tr *VirtualDesktopHostPool) GetObservation() (map[string]any, error) {
...
func (tr *VirtualDesktopHostPool) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this VirtualDesktopHostPool
func (tr *VirtualDesktopHostPool) GetID() string {
...
func (tr *VirtualDesktopHostPool) GetParameters() (map[string]any, error) {
...
func (tr *VirtualDesktopHostPool) SetParameters(params map[string]any) error {
...
// GetInitParameters of this VirtualDesktopHostPool
func (tr *VirtualDesktopHostPool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VirtualDesktopHostPool
func (tr *VirtualDesktopHostPool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
