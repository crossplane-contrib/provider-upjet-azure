...
// ConvertTo converts this NotificationHub to the hub type.
func (tr *NotificationHub) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the NotificationHub type.
func (tr *NotificationHub) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
