...
func (in *NotificationHubInitParameters) DeepCopyInto(out *NotificationHubInitParameters) {
	*out = *in
	if in.APNSCredential != nil {
		...
		*out = make([]APNSCredentialInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.BrowserCredential != nil {
		...
		*out = make([]BrowserCredentialInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.GCMCredential != nil {
		...
		*out = make([]GCMCredentialInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NotificationHubObservation) DeepCopyInto(out *NotificationHubObservation) {
	*out = *in
	if in.APNSCredential != nil {
		in, out := &in.APNSCredential, &out.APNSCredential
		*out = make([]APNSCredentialObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.BrowserCredential != nil {
		in, out := &in.BrowserCredential, &out.BrowserCredential
		*out = make([]BrowserCredentialObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NotificationHubParameters) DeepCopyInto(out *NotificationHubParameters) {
	*out = *in
	...
	if in.BrowserCredential != nil {
		in, out := &in.BrowserCredential, &out.BrowserCredential
		*out = make([]BrowserCredentialParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
