...
type LinkedServiceAzureSearchInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/search/v1beta2.Service
	...
	SearchServiceKeyRef *v2.Reference `json:"searchServiceKeyRef,omitempty" tf:"-"`

	// Selector for a Service in search to populate searchServiceKey.
	// +kubebuilder:validation:Optional
	SearchServiceKeySelector *v2.Selector `json:"searchServiceKeySelector,omitempty" tf:"-"`
