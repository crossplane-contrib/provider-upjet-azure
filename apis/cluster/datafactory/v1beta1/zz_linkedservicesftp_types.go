...
type LinkedServiceSFTPInitParameters struct {
	...
	PrivateKeyContentBase64SecretRef *v2.SecretKeySelector `json:"privateKeyContentBase64SecretRef,omitempty" tf:"-"`

	// The passphrase for the private key if the key is encrypted.
	PrivateKeyPassphraseSecretRef *v2.SecretKeySelector `json:"privateKeyPassphraseSecretRef,omitempty" tf:"-"`
