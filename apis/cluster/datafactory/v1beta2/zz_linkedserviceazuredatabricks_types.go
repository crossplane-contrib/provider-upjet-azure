...
type LinkedServiceAzureDatabricksInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	MsiWorkSpaceResourceIDRef *v2.Reference `json:"msiWorkSpaceResourceIdRef,omitempty" tf:"-"`

	// Selector for a Workspace in databricks to populate msiWorkSpaceResourceId.
	// +kubebuilder:validation:Optional
	MsiWorkSpaceResourceIDSelector *v2.Selector `json:"msiWorkSpaceResourceIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	MsiWorkspaceIDRef *v2.Reference `json:"msiWorkspaceIdRef,omitempty" tf:"-"`

	// Selector for a Workspace in databricks to populate msiWorkspaceId.
	// +kubebuilder:validation:Optional
	MsiWorkspaceIDSelector *v2.Selector `json:"msiWorkspaceIdSelector,omitempty" tf:"-"`
