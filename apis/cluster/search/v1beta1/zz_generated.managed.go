...
func (mg *SharedPrivateLinkService) GetCondition(ct xpv2.ConditionType) xpv2.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) GetDeletionPolicy() xpv2.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}

// GetManagementPolicies of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) GetManagementPolicies() xpv2.ManagementPolicies {
	return mg.Spec.ManagementPolicies
}

// GetProviderConfigReference of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) GetProviderConfigReference() *xpv2.Reference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) GetWriteConnectionSecretToReference() *xpv2.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetConditions of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) SetConditions(c ...xpv2.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) SetDeletionPolicy(r xpv2.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}

// SetManagementPolicies of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) SetManagementPolicies(r xpv2.ManagementPolicies) {
	mg.Spec.ManagementPolicies = r
}

// SetProviderConfigReference of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) SetProviderConfigReference(r *xpv2.Reference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this SharedPrivateLinkService.
func (mg *SharedPrivateLinkService) SetWriteConnectionSecretToReference(r *xpv2.SecretReference) {
	mg.Spec.WriteConnectionSecretToReference = r
}
