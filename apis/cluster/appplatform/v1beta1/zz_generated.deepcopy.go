...
func (in *SpringCloudConfigurationServiceInitParameters) DeepCopyInto(out *SpringCloudConfigurationServiceInitParameters) {
	*out = *in
	...
	if in.RefreshIntervalInSeconds != nil {
		in, out := &in.RefreshIntervalInSeconds, &out.RefreshIntervalInSeconds
		*out = new(float64)
		**out = **in
	}
	if in.Repository != nil {
...
func (in *SpringCloudGatewayInitParameters) DeepCopyInto(out *SpringCloudGatewayInitParameters) {
	*out = *in
	...
	if in.LocalResponseCachePerInstance != nil {
		...
		*out = make([]LocalResponseCachePerInstanceInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LocalResponseCachePerRoute != nil {
		...
		*out = make([]LocalResponseCachePerRouteInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.SensitiveEnvironmentVariables != nil {
		in, out := &in.SensitiveEnvironmentVariables, &out.SensitiveEnvironmentVariables
		*out = make(map[string]*string, len(*in))
		for key, val := range *in {
			var outVal *string
			if val == nil {
...
func (in *SpringCloudGatewayObservation) DeepCopyInto(out *SpringCloudGatewayObservation) {
	*out = *in
	...
	if in.LocalResponseCachePerInstance != nil {
		in, out := &in.LocalResponseCachePerInstance, &out.LocalResponseCachePerInstance
		*out = make([]LocalResponseCachePerInstanceObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LocalResponseCachePerRoute != nil {
		in, out := &in.LocalResponseCachePerRoute, &out.LocalResponseCachePerRoute
		*out = make([]LocalResponseCachePerRouteObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SpringCloudGatewayParameters) DeepCopyInto(out *SpringCloudGatewayParameters) {
	*out = *in
	...
	if in.LocalResponseCachePerInstance != nil {
		in, out := &in.LocalResponseCachePerInstance, &out.LocalResponseCachePerInstance
		*out = make([]LocalResponseCachePerInstanceParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LocalResponseCachePerRoute != nil {
		in, out := &in.LocalResponseCachePerRoute, &out.LocalResponseCachePerRoute
		*out = make([]LocalResponseCachePerRouteParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
