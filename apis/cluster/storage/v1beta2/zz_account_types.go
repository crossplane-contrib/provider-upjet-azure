...
type NetworkRulesInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	VirtualNetworkSubnetIdsRefs []v2.Reference `json:"virtualNetworkSubnetIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Subnet in network to populate virtualNetworkSubnetIds.
	// +kubebuilder:validation:Optional
	VirtualNetworkSubnetIdsSelector *v2.Selector `json:"virtualNetworkSubnetIdsSelector,omitempty" tf:"-"`
}
