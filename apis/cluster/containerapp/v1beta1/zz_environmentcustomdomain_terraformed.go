...
func (tr *EnvironmentCustomDomain) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"certificate_password": "certificatePasswordSecretRef"}
}
...
// LateInitialize this EnvironmentCustomDomain using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EnvironmentCustomDomain) LateInitialize(attrs []byte) (bool, error) {
	params := &EnvironmentCustomDomainParameters{}
