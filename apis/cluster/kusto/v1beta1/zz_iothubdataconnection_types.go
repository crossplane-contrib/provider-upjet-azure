...
type IOTHubDataConnectionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SharedAccessPolicyNameRef *v2.Reference `json:"sharedAccessPolicyNameRef,omitempty" tf:"-"`

	// Selector for a IOTHubSharedAccessPolicy in devices to populate sharedAccessPolicyName.
	// +kubebuilder:validation:Optional
	SharedAccessPolicyNameSelector *v2.Selector `json:"sharedAccessPolicyNameSelector,omitempty" tf:"-"`
