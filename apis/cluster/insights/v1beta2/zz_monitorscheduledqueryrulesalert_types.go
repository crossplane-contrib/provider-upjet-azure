...
type MonitorScheduledQueryRulesAlertActionInitParameters struct {
	...
	ActionGroupRefs []v2.Reference `json:"actionGroupRefs,omitempty" tf:"-"`

	// Selector for a list of MonitorActionGroup in insights to populate actionGroup.
	// +kubebuilder:validation:Optional
	ActionGroupSelector *v2.Selector `json:"actionGroupSelector,omitempty" tf:"-"`
...
type MonitorScheduledQueryRulesAlertInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AuthorizedResourceIdsRefs []v2.Reference `json:"authorizedResourceIdsRefs,omitempty" tf:"-"`

	// Selector for a list of ApplicationInsights in insights to populate authorizedResourceIds.
	// +kubebuilder:validation:Optional
	AuthorizedResourceIdsSelector *v2.Selector `json:"authorizedResourceIdsSelector,omitempty" tf:"-"`
