...
type AzureadAdministratorInitParameters struct {
	...
	LoginUsernameRef *v2.Reference `json:"loginUsernameRef,omitempty" tf:"-"`

	// Selector for a UserAssignedIdentity in managedidentity to populate loginUsername.
	// +kubebuilder:validation:Optional
	LoginUsernameSelector *v2.Selector `json:"loginUsernameSelector,omitempty" tf:"-"`
...
type MSSQLServerInitParameters struct {
	...
	// The Password associated with the administrator_login user. Needs to comply with Azure's Password Policy.
	AdministratorLoginPasswordWoSecretRef *v2.SecretKeySelector `json:"administratorLoginPasswordWoSecretRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PrimaryUserAssignedIdentityIDRef *v2.Reference `json:"primaryUserAssignedIdentityIdRef,omitempty" tf:"-"`

	// Selector for a UserAssignedIdentity in managedidentity to populate primaryUserAssignedIdentityId.
	// +kubebuilder:validation:Optional
	PrimaryUserAssignedIdentityIDSelector *v2.Selector `json:"primaryUserAssignedIdentityIdSelector,omitempty" tf:"-"`
