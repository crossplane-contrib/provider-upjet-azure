...
type ImportInitParameters struct {
	...
	AdministratorLoginPasswordSecretRef v2.SecretKeySelector `json:"administratorLoginPasswordSecretRef" tf:"-"`
	...
	StorageKeySecretRef v2.SecretKeySelector `json:"storageKeySecretRef" tf:"-"`
...
type MSSQLDatabaseInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	CreationSourceDatabaseIDRef *v2.Reference `json:"creationSourceDatabaseIdRef,omitempty" tf:"-"`

	// Selector for a MSSQLDatabase in sql to populate creationSourceDatabaseId.
	// +kubebuilder:validation:Optional
	CreationSourceDatabaseIDSelector *v2.Selector `json:"creationSourceDatabaseIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ElasticPoolIDRef *v2.Reference `json:"elasticPoolIdRef,omitempty" tf:"-"`

	// Selector for a MSSQLElasticPool in sql to populate elasticPoolId.
	// +kubebuilder:validation:Optional
	ElasticPoolIDSelector *v2.Selector `json:"elasticPoolIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TransparentDataEncryptionKeyVaultKeyIDRef *v2.Reference `json:"transparentDataEncryptionKeyVaultKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in keyvault to populate transparentDataEncryptionKeyVaultKeyId.
	// +kubebuilder:validation:Optional
	TransparentDataEncryptionKeyVaultKeyIDSelector *v2.Selector `json:"transparentDataEncryptionKeyVaultKeyIdSelector,omitempty" tf:"-"`
