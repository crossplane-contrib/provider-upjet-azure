...
type MSSQLServerMicrosoftSupportAuditingPolicyInitParameters struct {
	...
	BlobStorageEndpointRef *v2.Reference `json:"blobStorageEndpointRef,omitempty" tf:"-"`

	// Selector for a Account in storage to populate blobStorageEndpoint.
	// +kubebuilder:validation:Optional
	BlobStorageEndpointSelector *v2.Selector `json:"blobStorageEndpointSelector,omitempty" tf:"-"`
	...
	StorageAccountSubscriptionIDSecretRef *v2.SecretKeySelector `json:"storageAccountSubscriptionIdSecretRef,omitempty" tf:"-"`
}
