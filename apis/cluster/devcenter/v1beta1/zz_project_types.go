...
type ProjectInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/devcenter/v1beta1.Center
	...
	// +kubebuilder:validation:Optional
	DevCenterIDRef *v1.Reference `json:"devCenterIdRef,omitempty" tf:"-"`

	// Selector for a Center in devcenter to populate devCenterId.
	// +kubebuilder:validation:Optional
	DevCenterIDSelector *v1.Selector `json:"devCenterIdSelector,omitempty" tf:"-"`
