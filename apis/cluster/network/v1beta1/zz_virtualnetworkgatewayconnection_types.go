...
type VirtualNetworkGatewayConnectionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/cluster/network/v1beta1.LocalNetworkGateway
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/apis/cluster/network/v1beta1.VirtualNetworkGateway
