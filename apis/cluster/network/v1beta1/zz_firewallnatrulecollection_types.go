...
type FirewallNATRuleCollectionParameters struct {
	...
	// Specifies the name of the Firewall in which the NAT Rule Collection should be created. Changing this forces a new resource to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/network/v1beta2.Firewall
	// +kubebuilder:validation:Optional
	AzureFirewallName *string `json:"azureFirewallName,omitempty" tf:"azure_firewall_name,omitempty"`

	// Reference to a Firewall in network to populate azureFirewallName.
	// +kubebuilder:validation:Optional
	AzureFirewallNameRef *v2.Reference `json:"azureFirewallNameRef,omitempty" tf:"-"`

	// Selector for a Firewall in network to populate azureFirewallName.
	// +kubebuilder:validation:Optional
	AzureFirewallNameSelector *v2.Selector `json:"azureFirewallNameSelector,omitempty" tf:"-"`
...
type FirewallNATRuleCollectionRuleInitParameters struct {
	...
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("ip_address",true)
	...
	// +kubebuilder:validation:Optional
	DestinationAddressesRefs []v2.Reference `json:"destinationAddressesRefs,omitempty" tf:"-"`

	// Selector for a list of PublicIP in network to populate destinationAddresses.
	// +kubebuilder:validation:Optional
	DestinationAddressesSelector *v2.Selector `json:"destinationAddressesSelector,omitempty" tf:"-"`
