...
type TrafficAnalyticsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/operationalinsights/v1beta1.Workspace
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("workspace_id",true)
...
type WatcherFlowLogParameters struct {
	...
	// The name of the Network Watcher. Changing this forces a new resource to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/network/v1beta1.Watcher
	// +kubebuilder:validation:Optional
	NetworkWatcherName *string `json:"networkWatcherName,omitempty" tf:"network_watcher_name,omitempty"`

	// Reference to a Watcher in network to populate networkWatcherName.
	// +kubebuilder:validation:Optional
	NetworkWatcherNameRef *v2.Reference `json:"networkWatcherNameRef,omitempty" tf:"-"`

	// Selector for a Watcher in network to populate networkWatcherName.
	// +kubebuilder:validation:Optional
	NetworkWatcherNameSelector *v2.Selector `json:"networkWatcherNameSelector,omitempty" tf:"-"`
