...
func (tr *BastionHost) GetObservation() (map[string]any, error) {
...
func (tr *BastionHost) SetObservation(obs map[string]any) error {
...
func (tr *BastionHost) GetParameters() (map[string]any, error) {
...
func (tr *BastionHost) SetParameters(params map[string]any) error {
...
// GetInitParameters of this BastionHost
func (tr *BastionHost) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BastionHost
func (tr *BastionHost) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
