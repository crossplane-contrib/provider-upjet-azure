...
type RouteServerBGPConnectionParameters struct {
	...
	// The ID of the Route Server within which this Bgp connection should be created. Changing this forces a new resource to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/network/v1beta1.RouteServer
	...
	// +kubebuilder:validation:Optional
	RouteServerIDRef *v2.Reference `json:"routeServerIdRef,omitempty" tf:"-"`

	// Selector for a RouteServer in network to populate routeServerId.
	// +kubebuilder:validation:Optional
	RouteServerIDSelector *v2.Selector `json:"routeServerIdSelector,omitempty" tf:"-"`
}
