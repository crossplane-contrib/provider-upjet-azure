...
type InferenceClusterInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	KubernetesClusterIDRef *v2.Reference `json:"kubernetesClusterIdRef,omitempty" tf:"-"`

	// Selector for a KubernetesCluster in containerservice to populate kubernetesClusterId.
	// +kubebuilder:validation:Optional
	KubernetesClusterIDSelector *v2.Selector `json:"kubernetesClusterIdSelector,omitempty" tf:"-"`
...
type InferenceClusterParameters struct {
	...
	// +kubebuilder:validation:Optional
	MachineLearningWorkspaceIDRef *v2.Reference `json:"machineLearningWorkspaceIdRef,omitempty" tf:"-"`

	// Selector for a Workspace in machinelearningservices to populate machineLearningWorkspaceId.
	// +kubebuilder:validation:Optional
	MachineLearningWorkspaceIDSelector *v2.Selector `json:"machineLearningWorkspaceIdSelector,omitempty" tf:"-"`
