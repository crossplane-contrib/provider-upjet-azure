...
type SubscriptionInitParameters struct {
	...
	PrimaryKeySecretRef *v2.SecretKeySelector `json:"primaryKeySecretRef,omitempty" tf:"-"`
	...
	SecondaryKeySecretRef *v2.SecretKeySelector `json:"secondaryKeySecretRef,omitempty" tf:"-"`
