...
func (tr *CustomDomain) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"developer_portal[*].certificate": "developerPortal[*].certificateSecretRef", "developer_portal[*].certificate_password": "developerPortal[*].certificatePasswordSecretRef", "gateway[*].certificate": "gateway[*].certificateSecretRef", "gateway[*].certificate_password": "gateway[*].certificatePasswordSecretRef", "management[*].certificate": "management[*].certificateSecretRef", "management[*].certificate_password": "management[*].certificatePasswordSecretRef", "portal[*].certificate": "portal[*].certificateSecretRef", "portal[*].certificate_password": "portal[*].certificatePasswordSecretRef", "scm[*].certificate": "scm[*].certificateSecretRef", "scm[*].certificate_password": "scm[*].certificatePasswordSecretRef"}
}
