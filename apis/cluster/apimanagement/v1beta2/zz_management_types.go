...
type CertificateInitParameters struct {
	...
	CertificatePasswordSecretRef *v2.SecretKeySelector `json:"certificatePasswordSecretRef,omitempty" tf:"-"`

	// The Base64 Encoded PFX or Base64 Encoded X.509 Certificate.
	EncodedCertificateSecretRef v2.SecretKeySelector `json:"encodedCertificateSecretRef" tf:"-"`
...
type DelegationInitParameters struct {
	...
	ValidationKeySecretRef *v2.SecretKeySelector `json:"validationKeySecretRef,omitempty" tf:"-"`
}
