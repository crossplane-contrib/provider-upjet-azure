//go:build (operationsmanagement || all) && !ignore_autogenerated
...
// ConvertTo converts this LogAnalyticsSolution to the hub type.
func (tr *LogAnalyticsSolution) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the LogAnalyticsSolution type.
func (tr *LogAnalyticsSolution) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
