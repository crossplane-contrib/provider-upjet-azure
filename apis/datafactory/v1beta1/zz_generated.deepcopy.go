...
func (in *IntegrationRuntimeManagedInitParameters) DeepCopyInto(out *IntegrationRuntimeManagedInitParameters) {
	*out = *in
	if in.CatalogInfo != nil {
		in, out := &in.CatalogInfo, &out.CatalogInfo
		*out = make([]IntegrationRuntimeManagedCatalogInfoInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.CustomSetupScript != nil {
		in, out := &in.CustomSetupScript, &out.CustomSetupScript
		*out = make([]IntegrationRuntimeManagedCustomSetupScriptInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.VnetIntegration != nil {
		in, out := &in.VnetIntegration, &out.VnetIntegration
		*out = make([]IntegrationRuntimeManagedVnetIntegrationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *IntegrationRuntimeManagedObservation) DeepCopyInto(out *IntegrationRuntimeManagedObservation) {
	*out = *in
	if in.CatalogInfo != nil {
		in, out := &in.CatalogInfo, &out.CatalogInfo
		*out = make([]IntegrationRuntimeManagedCatalogInfoObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.CustomSetupScript != nil {
		in, out := &in.CustomSetupScript, &out.CustomSetupScript
		*out = make([]IntegrationRuntimeManagedCustomSetupScriptObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.VnetIntegration != nil {
		in, out := &in.VnetIntegration, &out.VnetIntegration
		*out = make([]IntegrationRuntimeManagedVnetIntegrationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
