...
// ConvertTo converts this SpringCloudConnection to the hub type.
func (tr *SpringCloudConnection) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the SpringCloudConnection type.
func (tr *SpringCloudConnection) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
