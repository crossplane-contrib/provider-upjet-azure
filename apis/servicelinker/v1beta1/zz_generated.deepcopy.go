//go:build (servicelinker || all) && !ignore_autogenerated
...
func (in *SpringCloudConnectionInitParameters) DeepCopyInto(out *SpringCloudConnectionInitParameters) {
	*out = *in
	...
	if in.SecretStore != nil {
		...
		*out = make([]SecretStoreInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SpringCloudConnectionObservation) DeepCopyInto(out *SpringCloudConnectionObservation) {
	*out = *in
	...
	if in.SecretStore != nil {
		in, out := &in.SecretStore, &out.SecretStore
		*out = make([]SecretStoreObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SpringCloudConnectionParameters) DeepCopyInto(out *SpringCloudConnectionParameters) {
	*out = *in
	...
	if in.SecretStore != nil {
		in, out := &in.SecretStore, &out.SecretStore
		*out = make([]SecretStoreParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
